...
/**
 * Helper function for creating [SquareVariantConfiguration] objects
 */
public fun SquareVariantConfiguration(
  srcs: Set<String>,
  deps: Set<SquareDependency>,
  tests: Map<String, SquareTestConfiguration>
): SquareVariantConfiguration = SquareVariantConfigurationImpl(
  srcs = srcs,
  deps = deps,
  tests = tests
)
